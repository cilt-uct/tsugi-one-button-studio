...
<div id="application">
    ...
    <ul class="nav nav-tabs">
        <li>
            <h1 style="margin-top: 0px;margin-bottom: 0px;padding-right: 20px;">One Button Studio: </h1>
        </li>
    ...
    <div id="schedule" class="tab-content">
        <div class="row">
            ...
            <div id="timer-container" class="col-xs-3">
                ...
                <ul class="nav nav-pills" style="float: right;margin-top: 20px;">
                    ...
                    <li role="presentation" style="style=" border-left:="" 1px="" solid="" #ccc;="" margin-left:15px;="" padding-left:8px;""=""><a href="#">Today</a></li>
                </ul>
        ...
        <div>
            <div class="row">
                <div class="col-xs-9" id="calendar" style="padding-right: 0px;">
