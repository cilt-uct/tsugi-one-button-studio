...
*/
        ...
        $('#btn_submit_booking').on('click', function(event) {
            ...
            $.post('<?php echo $action_process ?>', data, function( result ) {
        ...
        $('#calendar').on('click', '.open div[id*=d_]:not(.me):not(.used)', function(event) {
            ...
            // $.post('<?php echo $action_process ?>', { title: 'Test', date: _date.format('YYYY-MM-DD HH:mm:ss') }, function( data ) {
        ...
        $('#calendar').on('click', 'div.me[id*=d_]', function(event) {
            ...
            //     $.get(('<?php echo $action_get ?>').replace('{id}', _o.id), function(data){
            //         console.log(data);
